...
footer_image.src = "img/footer.gif";
//monster
...
reset.src = "img/restart.png";

//pause on content
var pause_content = new Image();
pause_content.src = "img/pause1.png";
...
var render = function() {
	...
	if (monster_ready) {
		if(monster1.show) {
			context.drawImage(monster, monster1.startX, monster1.startY, 110, 110);
		}
		if(monster2.show) {
			context.drawImage(monster, monster2.startX, monster2.startY, 110, 110);
		}
		if(monster3.show) {
			context.drawImage(monster, monster3.startX, monster3.startY, 110, 110);
		}
		if(monster4.show) {
			context.drawImage(monster, monster4.startX, monster4.startY, 110, 110);
		}
		if(monster5.show) {
			context.drawImage(monster, monster5.startX, monster5.startY, 110, 110);
		}
		if(monster6.show) {
			context.drawImage(monster, monster6.startX, monster6.startY, 110, 110);
		}
		if(monster7.show) {
			context.drawImage(monster, monster7.startX, monster7.startY, 110, 110);
		}	
		if(monster8.show) {
			context.drawImage(monster, monster8.startX, monster8.startY, 110, 110);
		}
	}
	//draw boom 
	if(boom_ready) {
